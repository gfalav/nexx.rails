...
class LineasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create linea" do
    assert_difference('Linea.count') do
      post lineas_url, params: { linea: { concepto_id: @linea.concepto_id, factura_id: @linea.factura_id, importe: @linea.importe, leyenda: @linea.leyenda } }
    end
  ...
  test "should update linea" do
    patch linea_url(@linea), params: { linea: { concepto_id: @linea.concepto_id, factura_id: @linea.factura_id, importe: @linea.importe, leyenda: @linea.leyenda } }

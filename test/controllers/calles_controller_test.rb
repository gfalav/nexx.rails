...
class CallesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create calle" do
    assert_difference('Calle.count') do
      post calles_url, params: { calle: { barrio_id: @calle.barrio_id, nombre: @calle.nombre } }
    end
  ...
  test "should update calle" do
    patch calle_url(@calle), params: { calle: { barrio_id: @calle.barrio_id, nombre: @calle.nombre } }

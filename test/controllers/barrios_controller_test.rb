...
class BarriosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create barrio" do
    assert_difference('Barrio.count') do
      post barrios_url, params: { barrio: { localidad_id: @barrio.localidad_id, nombre: @barrio.nombre } }
    end
  ...
  test "should update barrio" do
    patch barrio_url(@barrio), params: { barrio: { localidad_id: @barrio.localidad_id, nombre: @barrio.nombre } }

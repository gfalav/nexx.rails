...
class LocalidadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create localidad" do
    assert_difference('Localidad.count') do
      post localidades_url, params: { localidad: { municipio_id: @localidad.municipio_id, nombre: @localidad.nombre } }
    end
  ...
  test "should update localidad" do
    patch localidad_url(@localidad), params: { localidad: { municipio_id: @localidad.municipio_id, nombre: @localidad.nombre } }
